...
export async function POST(
  ...
  try {
    ...
    console.log(`[WHATSAPP_SESSION_CONNECT] User ${userAuth.id} has subscription:`, hasSubscription);
    ...
    console.log(`[WHATSAPP_SESSION_CONNECT] Looking for session: ${sessionId} for user: ${userAuth.id}`);
    console.log(`[WHATSAPP_SESSION_CONNECT] Found session:`, session ? `${session.id} (${session.sessionName}) - Token: ${session.token}` : 'null');
    ...
    console.log(`[WHATSAPP_SESSION_CONNECT] Making request to: ${WHATSAPP_SERVER_API}/session/connect`);
    console.log(`[WHATSAPP_SESSION_CONNECT] Using token: ${session.token}`);
    console.log(`[WHATSAPP_SESSION_CONNECT] Request body:`, { Subscribe, Immediate });
    ...
    console.log(`[WHATSAPP_SESSION_CONNECT] External service response status: ${response.status}`);
    console.log(`[WHATSAPP_SESSION_CONNECT] External service response:`, responseData);
