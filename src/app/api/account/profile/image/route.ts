...
// POST /api/account/profile/image - Upload profile image (same as PUT)
...
export async function PUT(request: Request) {
  try {
    ...
    console.error("[CUSTOMER_PROFILE_IMAGE_UPDATE]", error);
    return withCORS(NextResponse.json(
...
export async function DELETE(request: Request) {
  try {
    ...
    console.error("[CUSTOMER_PROFILE_IMAGE_DELETE]", error);
    return withCORS(NextResponse.json(
