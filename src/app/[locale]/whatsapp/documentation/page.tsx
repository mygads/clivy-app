...
const apiEndpoints: APIEndpoint[] = [
  ...
  },
  {
    ...
    description: 'Connect the WhatsApp session',
    category: 'Session',
    icon: <Wifi className="w-4 h-4" />,
    responseExample: {
      code: 200,
  ...
  },
  {
    ...
    description: 'Logout the WhatsApp session',
    category: 'Session',
    icon: <Wifi className="w-4 h-4" />,
    responseExample: {
      code: 200,
  ...
  },
  {
    ...
    title: 'Configure S3',
    description: 'Configure S3 for media storage',
    category: 'Session',
...
export default function APIDocsPage() {
  ...
  const EndpointBlock = ({ e }: { e: APIEndpoint }) => {
    ...
    return (
      <section
        ...
        className="group scroll-mt-20 sm:scroll-mt-24 rounded-lg sm:rounded-xl md:rounded-2xl border border-black/40 dark:border-gray-500 bg-gradient-to-br from-card/80 via-card/60 to-card/40 backdrop-blur-sm supports-[backdrop-filter]:bg-card/70 p-3 sm:p-4 md:p-6 lg:p-7 transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5"
      >
  ...
  return (
    <div ref={containerRef} className="relative flex w-full bg-background min-h-screen mt-20 sm:mt-28 lg:mt-32 pb-16 lg:pb-24">
      ...
      <main className="flex-1 min-w-0 bg-gradient-to-br from-background via-background to-muted/10 lg:pr-72 xl:pr-80 2xl:pr-96">
        <div className="mx-auto w-full max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-10">{/* improved responsive padding */}
          ...
          {/* Base URL Display */}
          <div className="mb-6 sm:mb-8 p-3 sm:p-4 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl border border-border/30 bg-gradient-to-br from-secondary/80 via-secondary/60 to-secondary/40 backdrop-blur-sm shadow-sm">
            <div className="flex flex-col gap-3 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-3">
