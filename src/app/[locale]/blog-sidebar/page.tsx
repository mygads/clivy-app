...
export async function generateMetadata({params}: {params: Promise<{locale: string}>}): Promise<Metadata> {
  ...
  const title = isIndonesian
    ? "Artikel Blog dengan Sidebar - Genfity | Wawasan Teknologi dan Digital"
    : "Blog Articles with Sidebar - Genfity | Technology and Digital Insights";
    
  const description = isIndonesian
    ? "Jelajahi artikel blog Genfity dengan navigasi sidebar yang mudah. Dapatkan tips, tutorial, dan wawasan terbaru tentang pengembangan teknologi, AI, dan strategi digital untuk bisnis Anda."
    : "Explore Genfity's blog articles with easy sidebar navigation. Get the latest tips, tutorials, and insights on technology development, AI, and digital strategies for your business.";

  return {
    title,
    description,
    keywords: isIndonesian
      ? "blog teknologi, artikel dengan sidebar, tutorial digital, tips pengembangan, insight bisnis"
      : "technology blog, articles with sidebar, digital tutorials, development tips, business insights",
    openGraph: {
      title,
      description,
      type: 'article',
              ...
              <div className="mb-10 mt-12 rounded-sm bg-white p-6 shadow-three dark:bg-gray-dark dark:shadow-none lg:mt-0">
                <div className="flex items-center justify-between">
                  <input
                    ...
                    className="border-stroke mr-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-hidden transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
                  />
                  <button
