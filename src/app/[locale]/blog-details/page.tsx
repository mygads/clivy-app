...
export async function generateMetadata({params}: {params: Promise<{locale: string}>}): Promise<Metadata> {
  ...
  const title = isIndonesian
    ? "Detail Artikel Blog - Genfity | 10 Situs Terbaik untuk Aset Digital Gratis"
    : "Blog Article Details - Genfity | 10 Amazing Sites for Free Digital Assets";
    
  const description = isIndonesian
    ? "Temukan 10 situs terbaik untuk mengunduh foto stok dan aset digital gratis untuk proyek Anda. Panduan lengkap dari tim ahli Genfity untuk meningkatkan kualitas desain dan konten digital."
    : "Discover 10 amazing sites to download free stock photos and digital assets for your projects. Complete guide from Genfity's expert team to enhance your design and digital content quality.";

  return {
    title,
    description,
    keywords: isIndonesian
      ? "foto stok gratis, aset digital gratis, download foto gratis, resource design, tools design"
      : "free stock photos, free digital assets, free photo download, design resources, design tools",
    openGraph: {
      title,
      description,
      type: 'article',
