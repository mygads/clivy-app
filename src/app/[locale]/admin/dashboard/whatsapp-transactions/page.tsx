                  ...
                  <TableRow key={transaction.id}>
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        ...
                        {(transaction as any).voucher && (
                          <div className="text-xs text-muted-foreground">
                            With voucher: {(transaction as any).voucher.code}
                          </div>
                        )}
                      </div>
                    </TableCell>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      ...
                      {(selectedTransaction as any).voucher && (
                        <div className="space-y-1">
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            Original: {formatCurrency(Number((selectedTransaction as any).originalPackagePrice || selectedTransaction.amount))}
                          </p>
                          <p className="text-sm text-green-600 dark:text-green-400">
                            Voucher: {(selectedTransaction as any).voucher.code} (-{formatCurrency(
                              Number((selectedTransaction as any).originalPackagePrice || selectedTransaction.amount) - Number(selectedTransaction.amount)
                            )})
                          </p>
                        </div>
                      )}
