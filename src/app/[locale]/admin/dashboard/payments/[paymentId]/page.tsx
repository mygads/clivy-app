              ...
              <CardContent className="space-y-4">
                ...
                {payment.transaction.user && (
                  <div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded mt-1">
                      <div className="flex items-start gap-3">
                        <User className="w-5 h-5 mt-0.5" />
                        <div className="space-y-2">
                          <div>
                            <p className="font-medium text-gray-900 dark:text-gray-100">
                              {payment.transaction.user.name || 'No name provided'}
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            <label className="text-xs font-medium text-gray-500 uppercase tracking-wider">Phone/WhatsApp</label>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                              {payment.transaction.user.phone || 'Not provided'}
                            </p>
                          </div>
                        </div>
                      </div>
