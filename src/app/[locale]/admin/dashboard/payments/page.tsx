...
export default function PaymentsPage() {
  ...
  const MethodBadge = ({ method }: { method: string }) => {
    ...
    const displayName = methodLabels[method] || method.replace(/_/g, ' ').toUpperCase()
                    ...
                    <TableRow key={payment.id}>
                      ...
                      <TableCell>
                        <div>
                          ...
                          {payment.transaction?.user?.phone && (
                            <div className="text-xs text-muted-foreground">{payment.transaction.user.phone}</div>
                          )}
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>                        
                        <div className="flex items-center gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => router.push(`/${locale}/admin/dashboard/payments/${payment.id}`)}
          ...
          <DialogHeader>
            ...
            <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <div className="text-muted-foreground">
                        Phone: {selectedPayment.transaction?.user?.phone || 'Not provided'}
                      </div>
                    </div>
                  </div>
                  <div>
              ...
              <div className="flex gap-2 pt-4 border-t">
                <Button
                  className="flex-1"
                  onClick={() => router.push(`/${locale}/admin/dashboard/payments/${selectedPayment.id}`)}
                >
