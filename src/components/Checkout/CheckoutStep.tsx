    ...
    >
      ...
      <div className="pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-800 flex justify-between">
        <button
          ...
          className="flex items-center gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors"
        >
