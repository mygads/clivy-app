...
export function VerificationStep({
  ...
  return (
    ...
    >
      <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Verifikasi Nomor WhatsApp</h2>

      <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 flex gap-2 sm:gap-3">
      ...
      {error && (
        <div className="mb-4 sm:mb-6 rounded-lg bg-red-50 p-3 sm:p-4 text-sm text-red-500 dark:bg-red-900/10 dark:text-red-400">
          {error}
        </div>
      )}

      {successMessage && (
        <div className="mb-4 sm:mb-6 rounded-lg bg-green-50 p-3 sm:p-4 text-sm text-green-500 dark:bg-green-900/10 dark:text-green-400">
          {successMessage}
        </div>
      )}
