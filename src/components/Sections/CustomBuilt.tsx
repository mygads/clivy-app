...
const features = [
  {
    ...
    description: "We build websites that reflect your unique brand identity, not generic templates.",
  },
  {
    icon: Code,
    title: "Developed In-House",
    description: "All our websites are developed in-house without outsourcing or foreign developers.",
  },
  {
    icon: Palette,
    title: "Custom Design",
    description: "Every design element is created specifically for your business, not just modified templates.",
  },
]
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-white md:text-4xl">
              We Build Websites <span className="text-primary">Without Templates</span>
            </h2>
            <p className="mb-8 md:mb-12 text-gray-600 dark:text-gray-300 text-base md:text-lg">
              Every business is unique, and your website should be too. We build every website from scratch, tailored
          ...
          >
            ...
            <div className="mt-8 md:mt-10 rounded-lg bg-gray-50 p-4 md:p-6 dark:bg-gray-800">
              <h3 className="mb-2 md:mb-4 text-lg md:text-xl font-bold text-gray-900 dark:text-white">
                Do You Have a Website That Needs Improvement?
              </h3>
              <p className="mb-3 md:mb-4 text-gray-600 dark:text-gray-300 text-sm md:text-base">
                Whether you&apos;re launching something new or fixing what others have broken — we&apos;re ready to help.
              </p>
              <div className="flex items-center">
                <CheckCircle className="mr-2 h-4 w-4 md:h-5 md:w-5 text-green-500" />
                <span className="text-gray-700 dark:text-gray-300 text-sm md:text-base">Free consultation to evaluate your website</span>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative h-56 xs:h-72 sm:h-80 md:h-[500px] w-full overflow-hidden rounded-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-primary/80 to-primary-dark/80">
                <div className="text-center text-white px-2">
                  ...
                  <p className="mb-3 md:mb-6 text-xs md:text-base">Built specifically for your business needs</p>
