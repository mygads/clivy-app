...
const benefits = [
  ...
  },
  {
    ...
    description: "Get insights into visitor behavior for better decision making.",
  },
  {
    icon: Users,
    title: "Optimal User Experience",
    description: "Websites designed with focus on user experience to increase conversions.",
  },
  {
    icon: Rocket,
    title: "High Performance",
    description: "Fast and responsive websites that deliver the best experience on all devices.",
  },
]
        ...
        <div className="grid items-center gap-10 md:gap-12 grid-cols-1 md:grid-cols-2">
          ...
          >
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-white md:text-4xl">
              Services We Provide for <span className="text-primary">Your Business</span>
            </h2>
            <p className="mb-6 md:mb-8 text-gray-600 dark:text-gray-300 text-base md:text-lg">
              We don&apos;t just build websites, but also provide comprehensive digital solutions to help
              your business grow.
            </p>
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-primary/80 to-primary-dark/80">
                <div className="grid grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-8 text-white">
                  <div className="text-center">
                    ...
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm">Traffic Increase</p>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl font-bold">87%</div>
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm">Conversion Increase</p>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl font-bold">24/7</div>
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm">Technical Support</p>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl font-bold">100%</div>
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm">Client Satisfaction</p>
                  </div>
                </div>
              </div>
            </div>
