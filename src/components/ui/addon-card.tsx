                ...
                <div className="p-4 sm:p-5 flex flex-col h-full">
                    ...
                    <div className="flex items-start justify-between mb-3 sm:mb-4">
                        <div className="flex-1">
                            <h3 className="font-semibold text-lg sm:text-xl mb-1 sm:mb-2 text-gray-900 dark:text-white">{title}</h3>
                            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{description}</p>
                        </div>
                    ...
                    {cartQuantity > 0 && (
                        <div className="mb-3 sm:mb-4">
                            <div className="flex items-center gap-2 py-1.5 sm:py-2 px-3 sm:px-4 bg-primary/5 rounded-lg border border-primary/20 dark:border-gray-600">
                            ...
                            {cartQuantity === 0 ? (
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        disabled={isAdding}
                                        className={cn(
                                            "flex-1 flex items-center justify-center rounded-lg px-2 py-2 text-xs sm:text-sm font-medium text-white bg-primary hover:bg-primary/90 hover:shadow-md hover:scale-105 transition-all duration-300 transform gap-1 sm:gap-2",
                                            isAdding && "bg-green-500 scale-95"
                                        )}
                                    >
                                        <FaCartPlus className={cn("h-3 w-3 sm:h-4 sm:w-4 transition-transform duration-300", isAdding && "animate-bounce")} />
                                        Add to Cart
                                    </button>
                                </div>
                            ) : (
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-primary hover:bg-primary/90 text-white transition-colors"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center justify-center gap-1 sm:gap-2 rounded-lg px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-foreground border border-primary dark:border-gray-400 hover:bg-primary hover:text-white dark:hover:border-gray-700 transition-all duration-300"
                                    >
