                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <Avatar className="h-8 w-8 ring-2 ring-purple-500/30 dark:ring-purple-400/30">
                                <AvatarImage src={user?.image || "/placeholder.svg"} alt={user?.name || "Admin"} />
                    ...
                    <DropdownMenuContent align="end" className="w-56 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                        ...
                        <DropdownMenuSeparator className="bg-gray-200/50 dark:bg-gray-700/50" />
                            <DropdownMenuItem className="hover:bg-gray-100/80 dark:hover:bg-gray-700/50 focus:bg-gray-100/80 dark:focus:bg-gray-700/50 text-gray-700 dark:text-gray-300" onClick={() => router.push(`/admin/dashboard/profile-settings`)}>
