...
export default function AdminSidebar({ open, setOpen, collapsed = false, setCollapsed }: AdminSidebarProps) {
  ...
  // Removed dropdown states since we're making them fixed
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: CreditCard,
      description: "Manage payment methods & gateways"
    },
    {
      title: "Bank Details",
            ...
            {!collapsed && (
              <>
                ...
                <div className="mt-6">
                  ...
                  {/* WhatsApp Menu Items - Always Visible */}
                    ...
                    {whatsappMenuItems.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <item.icon className={cn(
                            "h-5 w-5 transition-colors flex-shrink-0",
                            isActive ? "text-white" : "text-gray-700 dark:text-gray-300 group-hover:text-gray-800 dark:group-hover:text-gray-400"
                          )} />
                          <div className="flex flex-col">
                            <span className="font-medium">{item.title}</span>
                            {item.description && (
